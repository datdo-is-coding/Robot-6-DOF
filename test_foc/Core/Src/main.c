...
int main(void)
{
  ...
  MX_GPIO_Init();
  /* MX_ADC1_Init();  -- BO QUA: SimpleFOC Mini v2 KHONG co dien tro shunt do dong.
   * ADC doc chan PA0/PA1/PA2 dang floating co the gay Error_Handler -> treo chip.
   * Khi nao can current sensing thi moi bat lai. */
  MX_SPI1_Init();
  MX_TIM1_Init();
  /* USER CODE BEGIN 2 */
